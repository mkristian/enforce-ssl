...
p. info about the actual gem please look into the directory "enforce-ssl-gem":http://github.org/mkristian/enforce-ssl/enforce-ssl-gem

h2. demo rails application

p. the "demo":http://github.org/mkristian/enforce-ssl/demo is a sample rails3 application with integration tests. see "readme":http://github.org/mkristian/enforce-ssl/demo how to start the application and what limitations apply.
