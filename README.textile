...
p. the "demo":http://github.org/mkristian/ixtlan-guard/demo is a sample rails3 application with integration tests. see "readme":http://github.org/mkristian/ixtlan-guard/demo how to start the application and what limitations apply.
